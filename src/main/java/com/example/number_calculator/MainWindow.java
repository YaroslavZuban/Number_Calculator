...
public class MainWindow extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MainWindow.class.getResource("MainWindowInterfaceComplex.fxml"));
        ...
        ((ComplexController)fxmlLoader.getController()).init(stage);//устанавливаем сцену
